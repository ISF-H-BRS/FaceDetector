...
public:
    ...
    auto backend() const -> QString;
    auto scale() const -> unsigned int;
    auto mirrored() const -> bool;
...
signals:
    ...
    void scaleChanged(unsigned int scale);
...
private:
    std::unique_ptr<Ui::ControlWidget> m_ui;
};
